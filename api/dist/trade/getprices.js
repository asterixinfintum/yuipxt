...
function _getprices() {
  _getprices = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(date) {
    var stocks, cryptos, stockUpdatePromises, cryptoUpdatePromises;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          _context2.next = 11;
          return Promise.all([].concat(_toConsumableArray(stockUpdatePromises), _toConsumableArray(cryptoUpdatePromises)));
        case 11:
          _context2.next = 16;
          break;
        case 13:
...
var _default = exports["default"] = getprices;