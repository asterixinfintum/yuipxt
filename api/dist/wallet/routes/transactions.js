...
var transactions = _express["default"].Router();
transactions.post('/convert', _authenticateToken["default"], /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, toquant, fromquant, assetfrom, assetto, wallet, total, transactionFee, wllt, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          _context.next = 11;
          return wllt.swap(toquant, fromquant, assetto, assetfrom, transactionFee);
        case 11:
...
var _default = exports["default"] = transactions;