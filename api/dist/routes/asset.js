...
var _asset3 = _interopRequireDefault(require("../models/asset"));
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          _context2.next = 6;
          return _asset3["default"].findOne({
            _id: assetid
          });
        case 6:
...
asset.post('/admin/create/asset', /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body, symbol, name, image, assetType, _asset2, newAsset, savedAsset;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _req$body = req.body, symbol = _req$body.symbol, name = _req$body.name, image = _req$body.image, assetType = _req$body.assetType;
          _asset2 = {
            name: name,
            coin: symbol,
            symbol: symbol,
          ...
          newAsset = new _asset3["default"](_asset2);
          _context3.next = 6;
          return newAsset.save();
        case 6:
          savedAsset = _context3.sent;
          res.status(200).json({
            assetdetails: savedAsset
          });
          _context3.next = 14;
          break;
        case 10:
          ...
          res.status(500).json({
            error: 'An error occurred while createing asset'
          });
        case 14:
        case "end":
...
asset.post('/admin/create/allowedpair', /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body2, type, pairlabel, pair, pairItem, newPair, savedPair;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _req$body2 = req.body, type = _req$body2.type, pairlabel = _req$body2.pairlabel, pair = _req$body2.pair;
          pairItem = {
            type: type,
            pairlabel: pairlabel,
            pair: pair
          };
          newPair = new _allowedpair["default"](pairItem);
          _context4.next = 6;
          return newPair.save();
        case 6:
          savedPair = _context4.sent;
          res.status(200).json({
            savedPair: savedPair
          });
          _context4.next = 14;
        ...
        case 10:
          ...
          res.status(500).json({
            error: 'An error occurred while creating pair'
          });
        case 14:
        case "end":
