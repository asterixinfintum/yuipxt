...
function authenticateToken(req, res, next) {
  ...
  _jsonwebtoken["default"].verify(token, process.env.secretKeyJWT, /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(err, user) {
      var validtoken;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.next = 5;
            return _tokentracker["default"].findOne({
              unid: user._id,
              token: token
            });
          case 5:
