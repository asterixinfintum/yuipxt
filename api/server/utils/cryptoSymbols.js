const cryptoSymbols = [
    { symbol: 'BAT', name: 'Basic Attention Token', image: 'basic-attention-token-bat-logo.svg' },
    { symbol: 'BTC', name: 'Bitcoin', image: 'bitcoin-btc-logo.svg' },
    { symbol: 'BCH', name: 'Bitcoin Cash', image: 'bitcoin-cash-bch-logo.svg' },
    { symbol: 'BNB', name: 'Binance Coin', image: 'bnb-bnb-logo.svg' },
    ...
    { symbol: 'USD', name: 'USD Coin', image: 'usd-coin-usdc-logo.png' }
];
