...
var bitcoinRoute = _express["default"].Router();
...
bitcoinRoute.get('/createwallet', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var walletDetails, uniqueId, userAddress;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _createWallet["default"])();
        case 3:
          walletDetails = _context.sent;
          uniqueId = generateUniqueId(walletDetails.mnemonic);
...
bitcoinRoute.get('/dashboard', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var walletid, userWallet, address, transactions, ethereumaddress, usdtBalance, addressresp, utxos, totalAmountAvailable, _iterator, _step, utxo, exchangeresp, btc_price, balance, usdtExchangePrice;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          ...
          address = userWallet.address, transactions = userWallet.transactions, ethereumaddress = userWallet.ethereumaddress, usdtBalance = userWallet.usdtBalance;
          _context2.next = 9;
          return (0, _axios["default"])({
            method: "GET",
            url: "".concat(process.env.BTC_RPC, "/address/").concat(address, "/utxo")
          });
        case 9:
          addressresp = _context2.sent;
          utxos = addressresp.data;
        ...
        case 16:
          exchangeresp = _context2.sent;
          btc_price = exchangeresp.data.USD;
          balance = totalAmountAvailable / 100000000;
          console.log('dashboard:', balance, btc_price);
          usdtExchangePrice = "".concat(1.0);
          res.status(200).json({
            message: "Dashboard retrived successfully",
            dashboard: {
              ethereumaddress: "".concat(ethereumaddress),
              usdtExchangePrice: "".concat(usdtExchangePrice),
              usdtBalance: "".concat(usdtBalance),
              usdtBalanceUSD: "".concat(usdtBalance * usdtExchangePrice),
              btcaddress: "".concat(address),
              btcExchangePrice: "".concat(btc_price),
              btcBalance: "".concat(balance),
              btcBalanceUSD: "".concat(balance * btc_price),
...
bitcoinRoute.post('/webhook', /*#__PURE__*/function () {
...
var _default = exports["default"] = bitcoinRoute; //parade, feed, limb, size, crane, tourist, lift, can, injury, inherit, village, struggle
