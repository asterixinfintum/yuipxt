...
function estimateEthGas(_x) {
  return _estimateEthGas.apply(this, arguments);
}
function _estimateEthGas() {
  _estimateEthGas = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    var value, receiver, provider, transaction, estimatedGasLimit, gasLimitWithBuffer, gasPrice, adjustedGasPrice, gasFee;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          value = _ref.value, receiver = _ref.receiver;
          _context.prev = 1;
          provider = new _ethers.ethers.providers.JsonRpcProvider(process.env.ETH_RPC_MAINNET);
          transaction = {
            to: receiver,
            value: _ethers.ethers.utils.parseEther(value)
          }; // Estimate gas limit with a 20% buffer
          _context.next = 6;
          return provider.estimateGas(transaction);
        case 6:
          estimatedGasLimit = _context.sent;
          gasLimitWithBuffer = estimatedGasLimit.mul(120).div(100); // Get current gas price
          _context.next = 10;
          return provider.getGasPrice();
        case 10:
          gasPrice = _context.sent;
          // Slightly increase gas price to improve chances of quick inclusion
          adjustedGasPrice = gasPrice.mul(110).div(100); // 10% increase
          // Calculate total gas fee
          gasFee = adjustedGasPrice.mul(gasLimitWithBuffer);
          console.log("Estimated Gas Limit (with buffer):", gasLimitWithBuffer.toString());
          console.log("Adjusted Gas Price:", _ethers.ethers.utils.formatUnits(adjustedGasPrice, "gwei"), "Gwei");
          console.log("Estimated Max Gas Fee:", _ethers.ethers.utils.formatEther(gasFee), "ETH");
          ...
          return _context.abrupt("return", _objectSpread(_objectSpread({}, transaction), {}, {
            gasFee: _ethers.ethers.utils.formatEther(gasFee)
          }));
        case 22:
          _context.prev = 22;
